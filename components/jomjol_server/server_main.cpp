...
esp_err_t hello_main_handler(httpd_req_t *req)
{
    ...
    if ((strcmp(req->uri, "/") == 0) || (strcmp(req->uri, "/index.html") == 0))
    {
        ...
        {
            httpd_resp_sendstr_chunk(req, "<tr><td>Noch kein Bild aufgenommen und verarbeitet. <br> Bitte warten.</td></tr>");   
        }
        else
        {
            
            httpd_resp_sendstr_chunk(req, "<tr><td>Kamerabild<br><img src = \"/original.jpg\"></td></tr>");
            httpd_resp_sendstr_chunk(req, "<tr><td>Region-of-Interest<br><img src = \"/roi.jpg\"></td></tr>");
            httpd_resp_sendstr_chunk(req, "<tr><td>Input neuronales Netz<br><img src = \"/resize.bmp\"></td></tr>");
